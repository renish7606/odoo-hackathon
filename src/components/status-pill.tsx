...
const map: Record<string, string> = {
  ...
  Retired: "bg-slate-200 text-foreground ring-slate-300",
  Draft: "bg-slate-200 text-foreground ring-slate-300",
  Closed: "bg-slate-200 text-foreground ring-slate-300",
  "Off Duty": "bg-slate-200 text-foreground ring-slate-300",
  ...
  return (
    <span
      className={cn(
        ...
        map[value] ?? "bg-muted text-foreground ring-slate-200",
        className,
      )}
    >
      {value}

  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Crew Logs</h1>
          <p className="text-sm text-slate-500">Driver roster, license compliance, and safety scores.</p>
        </div>
      ...
      <div className="rounded-lg border border-slate-200 bg-white">
        ...
        <Table>
          ...
          <TableBody>
            ...
            {filtered.length === 0 && <TableRow><TableCell colSpan={7} className="text-center text-sm text-slate-500 py-8">No drivers.</TableCell></TableRow>}
          </TableBody>
        </Table>
      </div>
    </div>
